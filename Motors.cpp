...
void driveSides(int leftSpeed, int rightSpeed) {
  ...
  setWheel(PIN_L_FRONT, PIN_L_IN1, PIN_L_IN2, leftSpeed);  // LEFT FRONT
  setWheel(PIN_L_REAR,  PIN_L_IN3, PIN_L_IN4, leftSpeed);  // LEFT REAR
  setWheel(PIN_R_FRONT, PIN_R_IN1, PIN_R_IN2, rightSpeed); // RIGHT FRONT
  setWheel(PIN_R_REAR,  PIN_R_IN3, PIN_R_IN4, rightSpeed); // RIGHT REAR
}
